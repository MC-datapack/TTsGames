...
public class WrongJavaVersion {
    public WrongJavaVersion() {
        ...
        WindowOperations(6, new WindowInformation(false, new Point(500, 500), new Dimension(300, 100), Textures[0][3]), text);
        windows[6].setDefaultCloseOperation(WindowConstants.EXIT_ON_CLOSE);
    }
}
