package TTs.TTsGames.Games.DetektivAdler;
...
import static TTs.TTsGames.Resources.Translations.DetektivAdler;

public class DetektivAdler {
    public DetektivAdler(boolean resizable, Point location, Dimension size) {
        startedVersion = Versions[3];
        SwingUtilities.invokeLater(() -> {
            windows[2] = new JFrame(TTsGames[1] + Versions[3]);
            ...
            start.addActionListener(e-> {
                ...
                timer(() -> SwingUtilities.invokeLater(() -> {
