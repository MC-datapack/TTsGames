...
import TTs.swing.AnimatedImagePanel;
...
public class DetektivThunder {
    ...
    public DetektivThunder(boolean resizable, Point location, Dimension size) {
        ...
        SwingUtilities.invokeLater(() -> {
            windows[3] = new JFrame(TTsGames[2] + Versions[6]);
            ...
            entscheidungen[0] = new JButton(DetektivThunder[5]);
            entscheidungen[1] = new JButton(DetektivThunder[9]);
            entscheidungen[2] = new JButton(DetektivThunder[10]);
            entscheidungen[3] = new JButton(DetektivThunder[11]);
